...
public class delopalarm extends HttpServlet {
	public void destroy(){
		super.destroy();
	...
	public void doPost(HttpServletRequest request,HttpServletResponse response)throws ServletException,IOException{
		...
		try{
			...
			if(flag==0)
			{
				...
				sql="delete from Logs where UID in (select User_Login from Users where Substation_ID='"+sid+"') and OTim between '"+s+"' and '"+f+"'";
			}
			else
			{
				//System.out.print("all");
				sql="delete from Logs where UID in (select User_Login from Users where Substation_ID='"+sid+"')";
