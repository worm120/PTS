...
public class arcalarm extends HttpServlet {
	public void destroy(){
		super.destroy();
	...
	public void doPost(HttpServletRequest request,HttpServletResponse response)throws ServletException,IOException{
		...
		try{
			...
			int rc=0;
			String sql5="select * from AlarmLogArc a,Sample b where a.Odate between '"+s+"' and '"+f+"' and b.Substation_ID='"+sid+"' and b.Device_ID='"+did+"' and b.Sample_ID=a.Sample_ID and b.Sample_Type='02'";
			...
			if(rs6!=null)
			{
				...
				for(x=0;x<lineSize;x++)
				{
					if(rs6.next())
					{
						...
						out.println("<td>"+rs6.getInt("AlarmNum")+"</td>");
					...
					else if(!rs6.next() & k!=0 & x==0)
					{
						...
						sql6="select * from AlarmLogArc a,Sample b where a.Odate between '"+s+"' and '"+f+"' and b.Substation_ID='"+sid+"' and b.Device_ID='"+did+"' and b.Sample_ID=a.Sample_ID and b.Sample_Type='02'";
			...
			for(i=0;i<10;i++)
			{
		        ...
		        out.print("<td>"+i+"</td>");
		        out.print("<td>02</td>");
		        out.print("<td>uesr"+i+"</td>");  
		        out.print("<td>2014-10-"+i+" 11:11:11</td>");    
		        out.print("<td>处理完成</td>");
			...
			*/
			out.print("</tbody>"); 
			out.print("</table>");
			out.print("<p id='ncp2' style='display:none'>"+currentPage+"</p>");
			
			sql5="select * from AlarmLogArc a,Sample b where a.Odate between '"+s+"' and '"+f+"' and b.Substation_ID='"+sid+"' and b.Device_ID='"+did+"' and b.Sample_ID=a.Sample_ID and b.Sample_Type='02'";
			rs5=stmt.executeQuery(sql5);
			rc=0;
			if(rs5!=null){while(rs5.next()){rc++;}}
			if((rc%lineSize)!=0){ys=rc/lineSize+1;}
			else{ys=rc/lineSize;}
			out.print("<p id='nys2' style='display:none'>"+ys+"</p>");
			out.print("<p id='nrc2' style='display:none'>"+rc+"</p>");
