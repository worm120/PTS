...
public class pich extends HttpServlet {
	public void destroy(){
		super.destroy();
	...
	public void doPost(HttpServletRequest request,HttpServletResponse response)throws ServletException,IOException{
		...
		try{
			...
			int rc=0;
			String sql5="select * from Photo a,Sample b where a.Date between '"+s+"' and '"+f+"' and b.Substation_ID='"+sid+"' and b.Device_ID='"+did+"' and b.Sample_ID=a.Sample_ID and b.Sample_Type='00'";
	        ...
	        out.print("<th>时间</th>");
	        out.print("<th>采样点</th>");
	        out.print("<th>图片名称</th>");
	        out.print("<th>图片路径</th>");
	        out.print("<th>备注</th>"); 
	        out.print("</tr>");   
	        out.print("</thead>");
			out.print("<tbody>"); 
			...
			if(rs6!=null)
			{
				...
				for(x=0;x<lineSize;x++)
				{
					if(rs6.next())
					{
						...
						if(rs6.getString("Photo_Name")!=null){out.println("<td>"+rs6.getString("Photo_Name")+"</td>");}else {out.println("<td></td>");}
						if(rs6.getString("Photo_Location")!=null){out.println("<td>"+rs6.getString("Photo_Location")+"</td>");}else {out.println("<td></td>");}
					...
					else if(!rs6.next() & k!=0 & x==0)
					{
						...
						sql6="select * from Photo a,Sample b where a.Date between '"+s+"' and '"+f+"' and b.Substation_ID='"+sid+"' and b.Device_ID='"+did+"' and b.Sample_ID=a.Sample_ID and b.Sample_Type='00'";
			...
			*/
			...
			sql5="select * from Photo a,Sample b where a.Date between '"+s+"' and '"+f+"' and b.Substation_ID='"+sid+"' and b.Device_ID='"+did+"' and b.Sample_ID=a.Sample_ID and b.Sample_Type='00'";
