...
public class humexcela extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        // 创建工作表对象并命名  
        HSSFSheet sheet = wb.createSheet("湿度报警日志");  
        // 遍历集合对象创建行和单元格 
        ...
        response.setHeader("Content-disposition","attachment; filename=humalarmexcel.xls" );  
