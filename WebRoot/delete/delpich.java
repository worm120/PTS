...
public class delpich extends HttpServlet {
	public void destroy(){
		super.destroy();
	...
	public void doPost(HttpServletRequest request,HttpServletResponse response)throws ServletException,IOException{
		...
		try{
			...
			if(flag==0)
			{
				...
				sql="delete from Photo where Sample_ID in (select Sample_ID from Sample where Substation_ID='"+sid+"' and Sample_Type='00') and Date between '"+s+"' and '"+f+"'";
			}
			else
			{
				//System.out.print("all");
				sql="delete from Photo where Sample_ID in (select Sample_ID from Sample where Substation_ID='"+sid+"' and Sample_Type='00')";
			}
