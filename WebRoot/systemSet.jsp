...
<head>
    ...
    <script language="javascript" type="text/javascript" src="js/mainframe/systemSet.js"></script>
</head>
<%
	String[] sid=null;
	String[] sname=null;
...
<body>
    <div id="main-top">
        <div class="logo"><img class="topimgs" src="images/logo.gif"><div class="funType">系统设置</div><div class="funtip">当前菜单:</div></div>
        <div class="main_menu">
