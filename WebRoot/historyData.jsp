...
<head>
    ...
    <script language="javascript" type="text/javascript" src="js/mainframe/historyData.js"></script>
</head>
<%
...
<body>
    <div id="main-top">
        <div class="logo"><img class="topimgs" src="images/logo.gif"><div class="funType">历史数据</div><div class="funtip">当前菜单:</div></div>
        <div class="main_menu">
            <ul id="menu" class="topmenu-ul">
               <li class="topmenu-ul-li">
                ...
                <li class="topmenu-ul-li">
                    <a onclick="show('look')" ><i class="icon icon-user"></i><span class="usermenulispan">查看历史数据</span><i class="icon-sort-down"></i></a> 
                </li>
                
                <li class="topmenu-ul-li">
                    <a onclick="show('delete')">
                        <i class="icon icon-cog"></i>
                        <span class="usermenulispan">清除历史数据</span>
