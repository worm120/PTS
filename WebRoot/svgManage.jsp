...
<head>
    ...
    <script language="javascript" type="text/javascript" src="js/mainframe/svgManage.js"></script>
</head>
<%
...
<body>
    <div id="main-top">
        <div class="logo"><img class="topimgs" src="images/logo.gif"><div class="funType">接线图管理</div><div class="funtip">当前菜单:</div></div>
        <div class="main_menu">
            <ul id="menu" class="topmenu-ul">
                <li class="topmenu-ul-li">
                    <a onclick="showmenu('usermenu')" >
                            ...
                            <label id="sub_name" class="sunname" name="sub_name" ><--请选择变电所--></label>
                            <input id="sid" name="sid" type=hidden value="none" />
                        <i class="icon-sort-down"></i>
                    </a> 
                    <ul id="usermenu" style="display:none;z-index:200;left:10px;" >
                ...
                <li class="topmenu-ul-li">
                    <a onclick="show('linkSub')" >
                        <i class="icon icon-user"></i>
                        <span class="usermenulispan">关联变电所接线图</span>
                        <i class="icon-sort-down"></i>
                    </a> 
                </li>
                
                <li class="topmenu-ul-li">
                    <a onclick="show('linkDevNode')">
                        <i class="icon icon-cog"></i>
                        <span class="usermenulispan">关联设备（开关柜）节点</span>
                        <!--<i class="icon icon-sort-down"></i>-->
                    </a>
                </li>
                <li class="topmenu-ul-li">
                    <a onclick="show('delDevMap')">
                        <i class="icon icon-cog"></i>
                        <span class="usermenulispan">删除接线图</span>
                    </a>
                </li>
                
                <!-- 
                <li class="topmenu-ul-li">
                    <a onclick="show('linkDevMap')">
                        <i class="icon icon-cog"></i>
                        <span class="usermenulispan">关联开关柜接线图</span>
                    </a>
                </li>
                 -->
                <li class="topmenu-ul-li">
                    <a onclick="show('Mapedit')">
                        <i class="icon icon-cog"></i>
                        <span class="usermenulispan">接线图编辑器</span>
                        <!--<i class="icon icon-sort-down"></i>-->
                    </a>
                </li>
                <li class="topmenu-ul-li">
