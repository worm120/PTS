...
<head>
    ...
    <script language="javascript" type="text/javascript" src="js/mainframe/device.js"></script>
</head>
<%
...
<body>
    <div id="main-top">
        <div class="logo"><img class="topimgs" src="images/logo.gif"><div class="funType">设备管理</div><div class="funtip">当前菜单:</div></div>
        <div class="main_menu">
            <ul id="menu" class="topmenu-ul">
                <li class="topmenu-ul-li"> 
                    <a onclick="showmenu('usermenu')" >
                        <!-- <i class="icon icon-user"></i>
                            <input id="sub_name" class="sunname" name="sub_name" type="text" value="" disabled="true" >-->
                ...
                <li class="topmenu-ul-li">
                    <a onclick="deviceManage()">
                        <i class="icon icon-cog"></i>
                        <span class="usermenulispan">添加设备</span>
                        <!--<i class="icon icon-sort-down"></i>-->
                    </a>
                </li>
                <li class="topmenu-ul-li">
                    <a onclick="sampleManage()">
                        <i class="icon icon-cog"></i>
                        <span class="usermenulispan">添加采样点</span>
                        <!--<i class="icon icon-sort-down"></i>-->
                    </a>
                </li>
<!--                 <li class="topmenu-ul-li"> -->
...
<!--                     </a> -->
    ...
    <div id="closeAll" class="closeAll" onclick="closeAllScreen()">关闭全屏 </div>
</body>
