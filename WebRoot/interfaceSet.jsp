...
<head>
    ...
    <script language="javascript" type="text/javascript" src="js/mainframe/interfaceSet.js"></script>
</head>
<%
	String[] sid=null;
	String[] sname=null;
...
<body>
    <div id="main-top">
        <div class="logo"><img class="topimgs"  src="images/logo.gif"><div class="funType">接口设置</div><div class="funtip">当前菜单:</div></div>
        <div class="main_menu">
            <ul id="menu" class="topmenu-ul">
                ...
                <li class="topmenu-ul-li">
                    <a onclick="show('deviceInterface')" ><i class="icon icon-user"></i><span class="usermenulispan">设备关联设置</span><i class="icon-sort-down"></i></a> 
                </li>
                
                <li class="topmenu-ul-li">
                    <a onclick="show('sampleInterface')">
                        <i class="icon icon-cog"></i>
                        <span class="usermenulispan">采样点关联设置</span>
                        <!--<i class="icon icon-sort-down"></i>-->
                    </a>
                </li>
                
                <li class="topmenu-ul-li">
                    <a onclick="show('paraInterface')">
                        <i class="icon icon-cog"></i>
                        <span class="usermenulispan">接口参数设置</span>
                        <!--<i class="icon icon-sort-down"></i>-->
                    </a>
                </li>
