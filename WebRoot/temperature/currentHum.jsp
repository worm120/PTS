...
<head>
	...
	$(document).ready(function(){
    	...
    	<%
	    	...
	    	String getSubstation="select Sample.Sample_ID,Sample_Name,Sample_Place,HumValue from HumidityCurrent,Sample where Sample_Type='03' and  HumidityCurrent.Sample_ID = Sample.Sample_ID and Sample.Device_ID in(select Device_ID from Devpoint where Pid='"+request.getParameter("nodeid")+"')";
                ...
                <table class="table-style" id="listtable">
                  <thead>
                    <tr>
                        ...
                        <th class="table-style-th">湿度值</th>
                    </tr>
                  </thead>
                  <tbody>
                  	<%
