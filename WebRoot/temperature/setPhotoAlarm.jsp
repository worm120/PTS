...
<% 
	...
	String getP="select top 1 * from ReferPhoto where Sample_ID='"+pid+"' order by Date";
	rs=ds.select(getP);
	if(rs!=null)
	{
		while(rs.next())
		{
			if(rs.getString("Photo_Location")!=null&&rs.getString("Photo_Location").equals("")==false&&rs.getString("Photo_Location").equals("NULL")==false)
			{
				path="../liangw/images/photo/"+rs.getString("Photo_Name").toString();
			}
		}
	}
	rs.close();
...
<script type="text/javascript">
  jQuery(function($){
	...
	{
		$('#target').html("<img src='"+path+"' width='800' height='450'>");
	}
...
<div class="container" style="width:800px;margin-left:auto;margin-right:auto;">
