...
<html>
  <head>
	...
	<style type="text/css">
		...
		#menu{width:150px; height: 180px; background-color: #e2ecf5; font-size: 12px;}
	...
	<ul id="menu" style="display:none;"> 
	  ...
	  <li><a href="#">温度信息</a><div id="close" style="">关闭</div> 
	    <ul id="m1" > 
	      ...
	      <li><a href="#" id="historyTemp">历史温度数据 </a></li> 
	  ...
	  <li><a href="#">湿度信息</a> 
	    <ul id="m2" > 
	      ...
	      <li><a href="#" id="historyHum">历史湿度数据 </a></li> 
	  ...
	  <li><a href="#">图像信息</a> 
	    <ul id="m3" > 
	      <!-- 
	      <li><a href="#" id="curentPic">最新图像</a></li> 
	      <li><a href="#" id="curentResult">图像分析结果</a></li> 
	      <li><a href="#" id="historyPic">历史数据</a></li> 
	      <li><a href="#" id="getRemotePic">抓拍</a></li> 
	       -->
	      
	      <li><a href="#" id="picSet">查看设置</a></li> 
	      <!-- 
	      <li><a href="#" id="selSet">选区设置</a></li> 
	       -->
	      <li><a href="#" id="picCmp">分析结果</a></li> 
	      <li><a href="#" id="dataManage">数据管理</a></li>
	      <li><a href="#" id="alarmDeal">报警处理</a></li> 
	      <li><a href="#" id="getRemotePic">抓拍</a></li> 
	    </ul> 
	  </li> 
	  <li><a href="#">弧光信息</a> 
	    <ul id="m4" > 
	      <li><a href="#" id="qianghu">强弧</a></li> 
	      <li><a href="#" id="ruohu">局部放电</a></li> 
	      <li><a href="#" id="huguang">历史记录</a></li> 
	    </ul> 
	  </li> 
	  <!-- <li><a href="#" id="canshuSet">参数设置</a>  -->
	  </li> 
	  <li><a href="#" id="alarmTong">报警数据分析</a> 
	  </li>
	   <li><a href="#" id="health">健康状况评估</a> 
	  </li>
