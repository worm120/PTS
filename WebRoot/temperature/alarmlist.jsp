...
<html>
        ...
        <div id="content-field">
            <div class="box-content" >
                <table class="table-style" id="listtable">
                  ...
                  <tbody>
                  	<%
                  		String pid=request.getParameter("nodeid");//svg节点编号
		    			dataselect ds=new dataselect();
		    			String sqls="select * from AlarmLogTemperature left join SampleDetail on SampleDetail.Sample_ID=AlarmLogTemperature.Sample_ID where AlarmLogTemperature.Sample_ID in(select Sample.Sample_ID from Sample where Sample_Type='01' and Sample.Device_ID in(select Devpoint.Device_ID from Devpoint where pid='"+pid+"'))";
    ...
    <script type="text/javascript">
    	...
    	function chuli()
    	{
			...
			xmlhttp.open("GET","../servlet/settleAlarm?alarmid="+alarmID+"&userid=<%=session.getAttribute("user_id")%>&alarmcontent="+alarmcontent+"&r="+new Date().getTime(),true);
			xmlhttp.send();
    	}
    	function settle(id)
    	{
