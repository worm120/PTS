...
public class picexcela extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        // 创建工作表对象并命名  
        HSSFSheet sheet = wb.createSheet("图片报警日志");  
        // 遍历集合对象创建行和单元格 
        ...
        Cell2.setCellValue("报警图片photoid值"); 
        ...
        if(rs6!=null)
        {
        	int i=1;
        		...
        		while (rs6.next())
            	{
                    ...
                    Cell2.setCellValue(rs6.getFloat("AlarmPhoto")); 
        ...
        response.setHeader("Content-disposition","attachment; filename=picalarmexcel.xls" );  
