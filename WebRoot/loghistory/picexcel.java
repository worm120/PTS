...
public class picexcel extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        // 创建工作表对象并命名  
        HSSFSheet sheet = wb.createSheet("图片历史记录");  
        // 遍历集合对象创建行和单元格 
        ...
        if(rs6!=null)
        {
        	int i=1;
        		...
        		while (rs6.next())
            	{
                    ...
                    Cell4.setCellValue(rs6.getString("rem")); 
        ...
        response.setHeader("Content-disposition","attachment; filename=picexcel.xls" );  
