...
public class humalarm extends HttpServlet {
	public void destroy(){
		super.destroy();
	...
	public void doPost(HttpServletRequest request,HttpServletResponse response)throws ServletException,IOException{
		...
		try{
			...
			int rc=0;
			String sql5="select * from AlarmLogHumidity a,Sample b where a.Odate between '"+s+"' and '"+f+"' and b.Substation_ID='"+sid+"' and b.Device_ID='"+did+"' and b.Sample_ID=a.Sample_ID and b.Sample_Type='03'";
			...
			String sql6="select * from AlarmLogHumidity a,Sample b where a.Odate between '"+s+"' and '"+f+"' and b.Substation_ID='"+sid+"' and b.Device_ID='"+did+"' and b.Sample_ID=a.Sample_ID and b.Sample_Type='03'";
			...
			if(rs6!=null)
			{
				...
				for(x=0;x<lineSize;x++)
				{
					...
					else if(!rs6.next() & k!=0 & x==0)
					{
						...
						sql6="select * from AlarmLogHumidity a,Sample b where a.Odate between '"+s+"' and '"+f+"' and b.Substation_ID='"+sid+"' and b.Device_ID='"+did+"' and b.Sample_ID=a.Sample_ID and b.Sample_Type='03'";
			...
			*/
			...
			sql5="select * from AlarmLogHumidity a,Sample b where a.Odate between '"+s+"' and '"+f+"' and b.Substation_ID='"+sid+"' and b.Device_ID='"+did+"' and b.Sample_ID=a.Sample_ID and b.Sample_Type='03'";
