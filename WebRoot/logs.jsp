...
<head>
    ...
    <script language="javascript" type="text/javascript" src="js/mainframe/logs.js"></script>
</head>
<%
	String[] sid=null;
	String[] sname=null;
...
<body>
    <div id="main-top">
        <div class="logo"><img class="topimgs" src="images/logo.gif"><div class="funType">日志管理</div><div class="funtip">当前菜单:</div></div>
        <div class="main_menu">
            <ul id="menu" class="topmenu-ul">
                ...
                <li class="topmenu-ul-li">
                    <a onclick="show('baojing')" ><i class="icon icon-user"></i><span class="usermenulispan">报警日志</span><i class="icon-sort-down"></i></a> 
                </li>
                <li class="topmenu-ul-li">
                    <a onclick="show('alarm')">
                        <i class="icon icon-cog"></i>
                        <span class="usermenulispan">报警数据分析</span>
                ...
                <li class="topmenu-ul-li">
                    <a onclick="show('del')">
                        <i class="icon icon-cog"></i>
                        <span class="usermenulispan">删除日志</span>
                        <!--<i class="icon icon-sort-down"></i>-->
                    </a>
                </li>
