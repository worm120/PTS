...
<html>
    ...
    <body>
		...
		<%
	    	...
	    	for(int i=0;i<num;i++)
	    	{
    			out.print("<div class='box'><div class='photo'><img class='svgquan'  id='"+filename[i]+"'  src='"+"../svg/"+filename[i]+"' /></div><div class='imgname'>"+filename[i]+"</div><div class='msg'><span class='imgop' onclick='delSvg(\""+filename[i]+"\")'>删除</span><span class='imgop' onclick='yulan(\""+"../svg/"+filename[i]+"\")'>预览</span></div></div>");
	    	}
	    	rs.close();
	    	ds.close();	
	    %>
        ...
        <div id="zoom" style='position:fixed;z-index: 800;right:1px;bottom:0px;'><button type='button' onclick='big();'>放大 +</button><button type='button' onclick='small();'>缩小 -</button></div>
    </body>
